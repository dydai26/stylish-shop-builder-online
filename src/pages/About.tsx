...
const AboutPage = () => {
  ...
  return (
    <Layout>
      ...
      <section className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 text-center" data-animate>
        <h2 className="text-2xl sm:text-3xl md:text-[2.5rem] font-bold text-black mb-3 sm:mb-4" data-animate>Free consultation</h2>
        <p className="text-black text-sm sm:text-base md:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed" data-animate>
